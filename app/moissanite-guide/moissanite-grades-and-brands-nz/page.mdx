...
{/* VERIFY-FACT: confirm whether Miozuki exclusively uses D colour or offers other grades */}
...
{/* VERIFY-FACT: confirm the actual price difference between D and G-I grades in Miozuki's offerings, if any */}
...
{/* VERIFY-FACT: confirm whether Miozuki uses VVS1, VVS2, or both as standard */}
...
{/* VERIFY-FACT: confirm which brands and tiers Miozuki currently stocks, if any, and whether they offer multiple quality tiers */}
...
{/* VERIFY-FACT: confirm which grading labs Miozuki uses or accepts for their moissanite pieces */}
  ...
  items={[
    {
      ...
      /* VERIFY-FACT: confirm what colour and clarity Miozuki recommends or stocks as standard for engagement rings */
    },
    {
    ...
    },
    {
      ...
      /* VERIFY-FACT: confirm this is consistent with Miozuki's published durability claims */
    },
    {
...
{/* VERIFY-FACT: confirm these pricing ranges for Miozuki's current offerings, both for D-colour and for G-I grades, and for both NZ and AU markets */}
