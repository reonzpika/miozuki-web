...
{/* VERIFY: "most people land" claims should be confirmed with Ting, or reframed as "many prefer" rather than stating market data we don't own */}
...
{/* VERIFY: Confirm whether 1-2 carat is Miozuki's typical range or reframe as "many choose" */}
...
{/* VERIFY: These recommendations are archetypes; they should feel grounded in Ting's actual customer feedback or be reframed as "here's how some people think through this" */}
...
{/* VERIFY: Confirm duty threshold with Ting; verify whether Miozuki provides duties information and how */}
...
{/* VERIFY: Confirm relative durability of sterling silver vs gold in daily wear; check whether Ting has observed this in customer feedback */}
...
{/* VERIFY: The brides.com citation claiming "39% of New Zealand shoppers" was removed. brides.com is a US publication; its engagement ring statistics are about US shoppers, not NZ. This was a citation misattribution. Ting should confirm whether a statement about ethical preference should be included in this guide at all, and if so, with what source. */}
  ...
  items={[
    {
      ...
      // VERIFY: Confirm spending range with Ting
    },
    {
