...
export const metadata = {
  ...
  description:
    'Learn about pearl types, quality grades, and how to choose real pearls in New Zealand, including freshwater pearl necklaces and earrings.',
  alternates: { canonical: '/pearl-guide' },
};

# Pearls Explained: Your Guide to Choosing Real Pearls in New Zealand and Australia

<GuideSchema title="Pearls Explained: Types, Quality and Buying" path="/pearl-guide" updated="2026-08-26" />

A pearl is a precious gemstone formed inside an oyster or mussel when an irritant is wrapped in layers of nacre, the same lustrous substance that lines the shell. Every pearl you buy today is cultured, meaning a human hand started the process, and that's not a compromise; it's the only way to create the pearls we cherish, including Japanese akoya and Tahitian black pearls.

<figure className="my-6 overflow-hidden rounded-md bg-cream">
  <div className="relative aspect-[4/5] w-full sm:aspect-[3/4]">
    <Image
      src="https://cdn.shopify.com/s/files/1/0797/0819/3023/files/fresh-water-baroque-pearl-studs-5232105.jpg?v=1773183971"
      alt="Model wearing Miozuki Fresh Water Baroque Pearl Studs in warm side light"
      fill
...
| Pearl Type | Look | Lustre | Market Price Range | Best For |
|---|---|---|---|---|
| **Akoya** | Perfectly round, white, cream, or light gold | Mirror-bright, intense | ~NZ$400–NZ$1,400+ per pair | Classic elegance, special occasions, everyday investment |
| **Freshwater** | Baroque, potato-shaped, or round | Soft, creamy | ~NZ$330–NZ$800 per pair | Everyday wear, varied styles, budget-conscious choice |
| **Tahitian / Black** | Dark grey, black, bronze, with rose or green overtones | Mysterious, deep | ~NZ$380–NZ$5,000+ per pair | Statement pieces, skin tones with warm undertones |
...
**Freshwater pearls** come from mussels in lakes across China and other regions. They're looser in shape (often baroque, meaning irregular), richer in colour variation, and far more affordable. Freshwater isn't code for "lesser": it means different. You get character, originality, and the softness of a pearl that's less densely layered than akoya. At Miozuki, we work exclusively with freshwater pearls. Our collection includes [freshwater pearl necklaces](/collections/pearl-necklace-nz), [baroque pearl studs](/collections/pearl-earrings), and moissanite and pearl [pairings](/collections/bridal-jewellery), each designed for everyday wear or that moment you want to mark. Freshwater pearls are forgiving, beautiful, and made for pieces you reach for often.

If you're choosing a necklace, think about presence first: the [Freshwater Drop Pearl Necklace](/products/freshwater-pearl-necklace) is the most minimal, while layered and baroque strands create more shape at the neckline.
...
**Know your budget.** In the wider market, quality akoya studs sit at a higher price point because matching, roundness, and sharp lustre are harder to achieve. Tahitian pearls can sit much higher again because yields are smaller and the colours are rarer. Freshwater pearls usually offer the easiest entry into real pearl jewellery, especially for everyday studs, baroque shapes, and softer necklace styles. At Miozuki, we work with freshwater pearls, not akoya. For current Miozuki pricing, use the live product cards in each collection rather than a guide, because prices can change as materials, sizing, and designs change. Price should reflect nacre quality, lustre, setting, and how often you will wear the piece.
...
<HubCta heading="Explore freshwater pearls" body="Browse Miozuki freshwater pearl necklaces, including drop, layered, and baroque styles, then pair them with pearl earrings for a gentle, complete look." href="/collections/pearl-necklace-nz" label="Shop pearl necklaces" />
