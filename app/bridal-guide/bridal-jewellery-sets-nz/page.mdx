...
<GuideSchema title="Bridal Jewellery Sets NZ: How to Build Your Complete Look" path="/bridal-guide/bridal-jewellery-sets-nz" updated="2026-07-09" />
...
{/* VERIFY-EXP: "I design every Miozuki pair with this in mind..." - confirm this reflects Ting's actual design process, or she should describe it in her own words */}
...
| **Piece** | **Role in the Set** | **What It Needs to Match** | **Typical Budget (NZD)** |
|---|---|---|---|
| Earrings | The frame for your face | Neckline shape, hair style, veil placement | $280–$650 |
| Necklace | The centrepiece | Shoulder/neckline exposure, dress depth | $350–$800 |
| Bracelet | The finishing touch | Wrist visibility, dress sleeve | $250–$500 |
| **Full set** | Unified visual story | Dress style, time of day, personal aesthetic | $800–$1,950 |

{/* VERIFY-FACT: every NZD price in this article (this table, the pricing list further down, and the detailed set-comparison table) is an estimate, not sourced to Miozuki's actual current retail prices, confirm these ranges are accurate or correct them */}
...
{/* VERIFY-EXP: the neckline chart above is AI-generated as a flat line-art infographic (2026-07-09 diagram pilot), confirm you are happy with its look and that the pairings match your styling advice before launch */}
...
<HubCta heading="Explore bridal sets" body="Ready to build your set? Browse our rings, earrings, necklaces and bracelets, each designed and shipped from Auckland." href="/collections/bridal-jewellery" label="Shop bridal jewellery" />
...
{/* VERIFY-FACT: this whole paragraph is a placeholder example written by Claude, not a real Miozuki customer story, replace it with an actual set combination Ting has seen work, or a real bride's story if she has one to share */}
...
- Pearl stud earrings: $280–$420
- Moissanite stud or drop earrings: $350–$650
- Pearl pendant on chain: $380–$620
- Moissanite pendant on chain: $420–$700
- Bracelet (mixed stones or pearls): $250–$500
- **Complete three-piece set:** $800–$1,800 (depending on stones and metals)
...
| **Set Type** | **Best for** | **Moissanite Focus** | **Pearl Focus** | **Mixed Approach** | **Metal Flexibility** | **Price Range (NZD)** |
|---|---|---|---|---|---|---|
| Understated | Garden weddings, daytime | Subtle sparkle (studs only) | Studs + delicate pendant | Pearl studs + moissanite accent | White or yellow gold | $800–$1,200 |
| Classic | Most occasions, most brides | Studs or soft drops | Pearl pendant | Moissanite earrings + pearl pendant (signature pairing) | Any metal family | $1,000–$1,600 |
| Statement | Evening, formal, bold brides | Bold drops, larger stones | Hoops, baroque shapes | Moissanite drops + pearl bracelet | White or rose gold | $1,400–$1,950 |
| Minimalist | Modern aesthetic, clean lines | One small stud pair only | Delicate studs only | None or white-metal only | White gold or platinum | $600–$1,000 |
| Pearl-Forward | Classical, vintage, pearl lovers | None, or moissanite as accent only | Hoops + pendant + bracelet | Pearl primary with moissanite bracelet only | Yellow or white gold | $800–$1,500 |
| Layered | Evening, maximalist, bold | Multiple lengths (studs + necklace) | Multiple lengths | Mixed lengths at neckline | Rose or white gold | $1,500–$2,000 |
...
{/* VERIFY-EXP: "I design Miozuki pieces for exactly this moment..." - confirm this matches how Ting would describe her own design intent, or she should rewrite it in her own words */}
