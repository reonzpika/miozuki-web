...
<GuideSchema title="Promise Ring Meaning: What It Really Signifies" path="/moissanite-guide/promise-ring-meaning" updated="2026-07-10" />
...
When Ting first imagined Miozuki, she didn't begin with a business plan. She picked a fortune slip at a shrine in Fukuoka, Japan. The moment arrived during a quiet morning, at a time when she was asking herself what kind of jewellery she wanted to create, what story it should carry.

The name itself carries that origin. Miozuki, written as 澪月, means "waterway to the moon." It speaks to the idea of a path, a gentle flow, something that moves naturally toward light. That image sat at the heart of everything: [moissanite](/collections/moissanite-nz) that catches light like water reflects the moon, pearls that hold a soft glow, and the promise that fine jewellery doesn't have to be loud to be meaningful.
