...
<GuideSchema title="Bespoke Bridal Jewellery NZ: Design Process" path="/bridal-guide/bespoke-bridal-jewellery-nz" updated="2026-07-09" />
...
{/* VERIFY-FACT: Confirm the design and delivery process: what the initial conversation covers and how it's conducted, what format the rendering/sketch/3D model takes and when you receive it, and whether remote collection or shipping is offered for customers outside Auckland. */}

![The bespoke journey in five steps: conversation, design and quote, deposit, crafting, collection](/generated/diagram-bespoke-process.jpg)
...
{/* VERIFY-FACT: Confirm the full timeline and process flow: when stone sourcing happens relative to metalworking and setting, the typical number of weeks from design approval to completion, what progress updates are offered and how often, and the order of the steps in between. */}
...
{/* VERIFY-FACT: Confirm studio location (full street address and hours) and whether remote try-on appointments or shipping is offered for customers outside Auckland. */}
...
{/* VERIFY-FACT: Confirm the pricing structure: starting price or price range for a simple solitaire setting in 9ct or 18ct gold, whether Miozuki offers a published pricing menu or quotes are bespoke-only, typical deposit amount and percentage, when the balance is due, and the policy if the customer's circumstances change after deposit is paid. */}
...
{/* VERIFY-FACT: Confirm whether Miozuki's typical bespoke bridal rings exceed the AUD $1,000 customs duty threshold, the exact duty percentage applicable, any customs broker handling fees, whether Miozuki manages the customs paperwork and shipping or whether the customer arranges this independently, and the typical transit time from Miozuki to Australian delivery. */}
...
<HubFaq
  items={[
    ...
    },
    {
      ...
      a: 'No. You pay a deposit to secure the commission. The balance is due once the piece is finished and ready.',
    },
    {
      q: 'What kind of warranty or guarantee comes with a bespoke piece?',
      a: 'Every Miozuki piece comes with a guarantee covering the craftsmanship and materials.',
    },
  ]}
/>

{/* VERIFY-FACT: Confirm warranty terms: what's covered under the guarantee (craftsmanship, materials, stones), how long the warranty lasts, and what Miozuki's policy is on repairs or remake if the ring needs work after purchase. */}
