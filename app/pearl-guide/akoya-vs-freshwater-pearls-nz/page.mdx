...
{/* VERIFY: If Miozuki mentions specific customer stories about akoya or freshwater preferences, add those with this marker */}

{/* VERIFY: If there are specific current NZD or AUD price ranges that differ from $400-800 akoya and $150-400 freshwater, confirm and replace those ranges */}

{/* VERIFY: Confirm Miozuki ships to Australia and offers AUD pricing at checkout */}
