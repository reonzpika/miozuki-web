...
export default function AdminLessons() {
  return (
    <div>
      ...
      <p className="text-[15px] text-graphite max-w-xl mb-7">
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-7">
        <div className="rounded-2xl border border-border p-6 bg-gradient-to-b from-[#fdfaf4] to-champagne">
          ...
          <ul className="space-y-2 text-[15px] text-charcoal">
            {[
        ...
        <div className="rounded-2xl border border-border p-6 bg-gradient-to-b from-[#fcf0ef] to-blush">
          ...
          <ul className="space-y-2 text-[15px] text-charcoal">
            {[
              ...
              <li key={t} className="flex gap-2.5">
                <span className="text-burgundy mt-0.5 text-[10px]">◆</span>
                {t}
              </li>
            ))}
          </ul>
      ...
      <section className="bg-white-soft border border-border rounded-xl p-6 mb-6">
        <h2 className="font-serif text-lg text-charcoal mb-1">How to publish</h2>
        ...
        <ol className="space-y-2.5">
          {[
            ...
            <li key={t} className="flex gap-3.5 text-[15px] text-charcoal">
              <span className="flex-none w-6 h-6 rounded-full bg-burgundy text-white-soft text-[13px] font-medium flex items-center justify-center">
                {i + 1}
              </span>
              {t}
            </li>
      ...
      <section className="bg-white-soft border border-border rounded-xl p-6">
        <h2 className="font-serif text-lg text-charcoal mb-1">Visual guides</h2>
        <p className="text-sm text-graphite mb-4">
