...
{/* VERIFY: the Mohs chart above is AI-generated as a flat infographic (2026-07-09 diagram pilot), confirm you are happy with its look and that the figures read correctly before launch */}
...
{/* VERIFY: "moissanite fractures more unpredictably than diamond and is therefore tougher in practical daily wear" - Ting should confirm the exact mechanics of moissanite's crystal structure and whether this claim about fracturing is accurate to gemological literature */}
...
{/* VERIFY: "gold-filled rings last 5-7 years of daily wear before needing refinishing; solid gold lasts a generation or more" - Ting should confirm realistic timelines for NZ daily-wear conditions */}
...
{/* VERIFY: "never use harsh chemical cleaners on sterling silver" - Ting should confirm safe cleaning practices and any specific restrictions */}
