...
<GuideSchema title="How to Choose a Moissanite Ring" path="/moissanite-guide/how-to-choose-a-moissanite-ring" updated="2026-07-09" />
...
| **Stone size** | Carat weight (0.5 to 5+ ct) | 1 to 2 carat | Noticeable presence without feeling oversized in daily wear |
...
{/* VERIFY-FACT: "most people land" claims should be confirmed with Ting, or reframed as "many prefer" rather than stating market data we don't own */}
...
{/* VERIFY-FACT: Confirm whether 1-2 carat is Miozuki's typical range or reframe as "many choose" */}
...
{/* VERIFY-FACT: Confirm duty threshold with Ting; verify whether Miozuki provides duties information and how */}
...
**Earrings:** Small moissanite studs (0.5 carat each) or simple pearl studs
...
{/* VERIFY-FACT: Confirm relative durability of sterling silver vs gold in daily wear; check whether Ting has observed this in customer feedback */}
  ...
  items={[
    {
      ...
      a: 'There\'s no "should." The honest answer is: as much as you can comfortably afford, and not a penny more. A beautiful ring at NZD 800 beats a stressful one at NZD 3,000. Most people spend between NZD 800 and NZD 2,000. That range buys you quality stone, thoughtful design, and peace of mind.',
      // VERIFY-FACT: Confirm spending range with Ting
    },
    {
