...
{/* VERIFY-FACT: The resale percentages here (50-70% for diamonds, 10-30% for moissanite) are estimates. Ting, should these be qualified as "typical ranges" or "estimates based on" something specific? Do you have Miozuki-specific data or industry ranges I should cite instead? */}
