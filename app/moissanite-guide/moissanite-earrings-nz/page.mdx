...
{/* VERIFY-EXP: "0.5 to 1.0 ct per stone reads as substantial", confirm this reflects real Miozuki customer feedback or typical guidance */}
...
{/* VERIFY-EXP: "you're glowing, not broadcasting" is impressionistic language, confirm this matches Ting's actual framing of everyday moissanite wear */}
...
{/* VERIFY-FACT: "expect a rough doubling of price as you move from 0.5 ct to 1.0 ct to 1.5 ct", confirm actual Miozuki pricing structure, name the specific prices for comparison */}
...
{/* VERIFY-FACT: "A pair of 1.0 ct studs at approximately NZD $450–$600", confirm actual current pricing */}
...
Moissanite doesn't require special care. A soft cloth and warm water once a month is plenty. You can take moissanite earrings to the beach, the gym, the shower. It's not going to cloud or dull. For more on caring for your moissanite, see our [jewellery care guide](/pages/jewellery-care-guide).
