...
<GuideSchema title="Moissanite Grades and Brands: What Matters" path="/moissanite-guide/moissanite-grades-and-brands-nz" updated="2026-07-10" />
...
{/* VERIFY-EXP: the grade scale chart above is AI-generated as a flat infographic (2026-07-09 diagram set), confirm you are happy with its look before launch */}
...
What does this actually look like? A D-colour moissanite catches every ray of light in your room and throws it back as pure, prismatic fire. Under daylight, under office fluorescents, under the yellow glow of a restaurant candle, it looks the same: bright, clear, and alive. This is the gold standard for [moissanite jewellery](/collections/moissanite-nz) in New Zealand and Australia. Miozuki stocks D-colour moissanite only.
...
For New Zealand and Australian customers shopping the wider market, G-I grades are the practical choice for everyday moissanite. You get the same visual clarity as D-colour, the same durability, and you save 10-15% on price. At Miozuki, all grades are the same price, since pricing is determined by style, design, and carat size rather than grade.
...
Miozuki does not stock named brand tiers or multiple quality grades. These branded lines remain market context only.
...
{/* VERIFY-EXP: expand this section with Miozuki's own reasoning or philosophy about colour and clarity grading, if you have customer-facing statements about it */}
...
What it is: a reliable third-party assessment of what you're buying. If you're ordering online and can't see the stone in person, a certificate from GCAL or GIA gives you confidence. If you're buying in person from a local jeweller in New Zealand or Australia, a certificate is useful for insurance and for future resale, but your eye and the jeweller's reputation matter more. Miozuki does not use or require grading lab certification; the lab-grading discussion above is market context only.

<HubCta heading="Ready to find your grade?" body="Browse moissanite rings, earrings, and sets, available through our Auckland-based online store. Find the grade and style that feels right for you." href="/collections/moissanite-nz" label="Browse moissanite" />

<HubFaq
  items={[
    {
      q: 'What colour and clarity grade should I choose for an engagement ring?',
      a: 'At Miozuki, the standard for engagement rings is D colour and VVS1 to VVS2 clarity, with one price per design regardless of grade, since pricing is determined by style, design, and carat rather than grade. For the wider market, D colour and VVS1 to VVS2 clarity is the traditional choice and the easiest to defend later. G-I colour and VS1 clarity is smarter money if you\'re shopping beyond Miozuki: you save 15-20% and gain zero visible difference in daily wear. SI1 and below start showing faint haziness under some lights; skip them for engagement rings unless you\'re a deliberate risk-taker or the stone is very small.',
    },
    {
    ...
    },
    {
      ...
      a: 'No. Moissanite doesn\'t yellow or cloud or lose clarity over time with normal wear, regardless of clarity grade. A VVS1 stone stays visually identical at year one and year twenty, and the same is true for any Miozuki moissanite. The stone itself is permanent. The metal setting can scratch or wear, and a dirty setting can make the stone look duller (easily fixed with cleaning), but the moissanite itself never changes.',
    },
    {
...
Moissanite prices in New Zealand and Australia are typically quoted in NZD for local customers and AUD for Australian shoppers, with the same stone available on either side of the Tasman. Exchange rates affect the final cost, but pricing approaches vary widely.

In the wider NZ market, gold-set moissanite pieces run roughly NZ$1,500 to NZ$4,000 for 2ct+ engagement rings, with smaller pieces (earrings, 0.5 to 1-carat studs and rings) ranging from NZ$300 to NZ$800 for good-quality mid-tier grades, and NZ$2,000 to NZ$6,000+ for branded top-tier stones like Forever One.

At Miozuki, pricing is simpler: one grade standard (D colour, VVS1-VVS2), studs from NZ$255, rings from NZ$320 to NZ$795, priced by design and carat rather than grade.
...
{/* VERIFY-EXP: confirm this aligns with Miozuki's durability messaging and whether you've had any customer reports of moissanite clouding or yellowing */}
...
{/* VERIFY-EXP: Update the GIA citation URL to a working page. The moissanite grading industry uses the GIA's D-Z color scale; verify the correct GIA page URL that documents this scale. Current URL path may be incorrect. */}
