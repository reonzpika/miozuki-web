        ...
        >
          ...
          >
            ...
            <p className="text-sm text-charcoal/55 mb-5 leading-relaxed">
              ...
              first to ensure the perfect fit. Please allow approximately 4 to 6
              weeks lead time.
            </p>

            <ul className="text-sm text-charcoal/70 space-y-1.5 mb-6 leading-relaxed list-disc pl-4">
            ...
            <div className="border-t border-charcoal/8 pt-6 mb-6">
              ...
              >
                ...
                />
                <span className="absolute bottom-2 right-2 text-xs tracking-widest uppercase bg-cream/95 text-charcoal/70 px-2.5 py-1 border border-charcoal/15">
                  Enlarge
                </span>
              </button>
            </div>
