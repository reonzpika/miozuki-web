...
**Price and metal rules (updated 2026-08-14).** Never put a Miozuki price in the same sentence or table cell as a broader market price for gold-set jewellery; market figures must name their basis ("typically set in 10k-18k gold"). Miozuki moissanite rings now have live-priced selectable 9k gold options on most styles, in white, yellow, and rose gold. Use "9k gold" as the main customer-facing wording and "9ct gold" naturally where useful for NZ search. Do not write "we only sell silver" or imply gold is custom-quoted only for the current ring range.
