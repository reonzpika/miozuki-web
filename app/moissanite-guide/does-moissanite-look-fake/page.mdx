...
Every Miozuki stone is lab grown, so there is no mining in the supply chain. That is the core of the ethical claim. Lab-grown moissanite is made in a controlled environment, real and durable, and it comes without the extraction cost. You get a real stone with a better origin story.
