...
| Moissanite is fragile compared to diamond | Moissanite is nearly as hard as diamond (9.25 vs 10) and tougher in some ways | Virtually identical durability, different beauty |
...
**Toughness** is resistance to breakage or chipping when struck. This is where moissanite is interesting, and where the myth of the "fragile lab-grown stone" starts to break down.

Moissanite can chip. All gemstones can. If you drop a two-carat moissanite solitaire onto a concrete pavement from waist height and it lands at the right angle, you might chip the edge. The same is true of diamond. The same is true of every faceted stone. The difference is frequency.

What makes moissanite remarkable is that it's tougher than most people think. It doesn't have the internal structure that makes a diamond susceptible to cleaving along a plane. Moissanite is not isotropic in the same way, which means it fractures more unpredictably, and that actually works in its favour for day-to-day toughness. A diamond might cleave cleanly and catastrophically. Moissanite tends to chip in small ways, or not at all.

{/* VERIFY-FACT: "moissanite fractures more unpredictably than diamond and is therefore tougher in practical daily wear" - Ting should confirm the exact mechanics of moissanite's crystal structure and whether this claim about fracturing is accurate to gemological literature */}

I've never seen a moissanite stone actually break from normal wear in a Miozuki piece. I've seen prongs bend and shift. I've seen bands weaken and need resizing. I've seen the metal backing lose its finish. I've never seen the moissanite itself fail.

Is it impossible? No. Could you chip a moissanite if you banged it hard enough on a stone floor? Yes. But you could do the same to a diamond. The difference is that moissanite is forgiving. It's less likely to fail catastrophically.
...
| Toughness (resistance to chipping) | Can chip under high-impact lateral force, but less likely than diamond because it doesn't cleave along a plane. Practical chipping risk is low. | Falls onto pavement or concrete could chip an edge, but this is rare. Same risk as diamond. |
  ...
  items={[
    {
      ...
      a: 'Moissanite can chip, but only under significant lateral impact, not from everyday bumps or normal wear. The difference between hardness and toughness matters here: moissanite is hard (scratch-proof) but not infinitely tough to chipping. Compared to diamond, it\'s actually slightly more forgiving because it doesn\'t cleave along a plane. I\'ve never seen a moissanite chip in a Miozuki piece from daily wear.',
    },
    {
