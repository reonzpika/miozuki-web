...
<GuideSchema title="Pearl Earrings Buying Guide NZ: Everyday to Occasion" path="/pearl-guide/pearl-earrings-nz" updated="2026-07-09" />
...
{/* VERIFY-FACT: Is the statement about S925 sterling silver stamping accurate for all Miozuki pearl studs? Check with Ting. */}
...
{/* VERIFY-FACT: Is baroque pearl pricing identical to smooth pearl pricing at Miozuki, or does baroque command a premium or discount? Clarify for Ting. */}
...
{/* VERIFY-FACT: Check actual product availability and pricing at Miozuki. Confirm the price ranges are current and that all listed styles actually exist. */}
