  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        onClick={() => scroll('left')}
        className="hidden md:flex absolute left-4 top-[45%] -translate-y-1/2 h-10 w-10 rounded-full bg-burgundy text-cream items-center justify-center shadow-lg transition-colors hover:bg-accent-hover"
      >
      ...
      <button
        ...
        className="hidden md:flex absolute right-4 top-[45%] -translate-y-1/2 h-10 w-10 rounded-full bg-burgundy text-cream items-center justify-center shadow-lg transition-colors hover:bg-accent-hover"
      >
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
