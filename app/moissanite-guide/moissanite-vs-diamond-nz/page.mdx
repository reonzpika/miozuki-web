...
{/* VERIFY: "I've been designing with it for years, and I still believe it's the more thoughtful choice for most people" - confirm this matches Ting's actual history with moissanite, or she should adjust the timeframe/framing */}
...
{/* VERIFY: every NZD price in this article (the table above, the Cost section, and the point-by-point comparison table further down) is an estimate, not sourced to Miozuki's actual current retail prices, confirm these ranges are accurate or correct them */}
...
{/* VERIFY: the fire diagram above is AI-generated as a flat infographic (2026-07-09 diagram pilot), confirm you are happy with its look before launch */}
...
<HubFaq
  items={[
    ...
    },
    {
      ...
      /* VERIFY: "I've seen moissanite stones that have been worn daily for over 15 years, and they're pristine" - confirm this is genuinely something Ting has observed, or she should replace it with her own real timeframe/example */
    },
    {
      ...
      /* VERIFY: "A customer once asked me outright whether her moissanite would give the game away in her wedding photos" is a placeholder example written by Claude, not a real Miozuki customer story, replace it with an actual question Ting has been asked, or remove the sentence if none comes to mind */
    },
    {
