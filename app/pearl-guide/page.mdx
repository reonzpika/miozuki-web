...
{/* VERIFY-FACT: the price ranges in the type table and the budget section were drafted as estimates AND the akoya range here (NZ$800-2,500+ per pair) contradicts the akoya guide's NZ$400-800 for quality studs, reconcile both pages to the same true ranges before launch */}
