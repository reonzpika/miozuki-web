...
If Node is missing: download from https://nodejs.org (LTS version).
...
## Step 7: Set up the Ctrl+Alt+P publish shortcut
...
5. Check https://github.com/reonzpika/miozuki-web/commits/master — confirm a new commit appears with a timestamp in the message
...
## Step 9: Walk Ting through TING-GUIDE.md
